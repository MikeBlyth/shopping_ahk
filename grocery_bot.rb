...
class WalmartGroceryAssistant
  ...
  def start
    if @readonly
      puts "🔒 STARTING IN READ-ONLY MODE".colorize(:yellow)
      puts "   - No changes will be saved to the database"
      puts "   - No changes will be saved to Google Sheets"
      puts "   - No backups will be created"
    end
